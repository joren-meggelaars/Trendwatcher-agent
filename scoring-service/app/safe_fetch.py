...
weekly discovery, feed ingest). A copy of this module lives in scheduler/
(separate project, same code; keep them identical apart from
_default_allow_private).
...
def _default_allow_private() -> bool:
    return settings.safe_fetch_allow_private
